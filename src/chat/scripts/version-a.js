...
export const STAGES = {
  ...
  '6-unsure': {
    beats: [
      l('That’s alright.', 1),
      l('The full reading maps it precisely, down to the city your love line runs through. You may be surprised how close it is.', 1),
    ],
    next: '7',
  },
  ...
  '9': {
    beats: [
      ...
      l('Within 24 hours you’ll have the full face, the personality profile, why your Vedic chart matches theirs, and the place where you’re most likely to meet.', 1),
