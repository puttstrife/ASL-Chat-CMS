...
export const SHARED_STAGES = {
  ...
  '1': {
    beats: [
      ...
      l('99% of readings only look at your sun sign.', 1.5),
      l('One placement.', 1),
      l('The same one shared by millions of people born the same month as you.', 1),
      l('That’s why every sketch you’ve ever seen felt like it could be anyone.', 1.5),
      l('I don’t work that way.', 1.5),
      l('I open your birth chart and read all 12 placements.', 1),
      l('The whole sky as it stood the moment you arrived.', 1),
  ...
  '2': {
    beats: [
      ...
      l('The day you were born, the sky arranged itself into a pattern that has never repeated since.', 1.5),
      l('Not once.', 1),
      l('That pattern is your birth chart.', 1.5),
      l('And hidden inside it, like a lock holding the shape of its key, is theirs.', 1),
  ...
  '3b': {
    beats: [
      ...
      l('{name}... do you know someone with this kind of presence?', 1),
      l('Or have you felt drawn to this energy before?', 1),
    ],
    buttons: [
  ...
  '3-no': {
    beats: [
      ...
      l('A signal like this only registers when someone has crossed your path.', 1),
      l('Even briefly.', 1),
      l('Even for a moment.', 1),
  ...
  '3-maybe': {
    beats: [
      ...
      l('But your chart logged that encounter for a reason.', 1),
      l('When the sketch is done, you’ll know whether your instinct was right.', 1),
    ],
    next: '4',
  },
  ...
  '3-still-no': {
    beats: [
      ...
      l('It means you’ll see their face before you ever meet them.', 1),
      l('Almost nobody gets it in that order.', 1),
    ],
    next: '4',
  },
  ...
  '4': {
    beats: [
      ...
      l('This takes me a moment because I don’t sketch from imagination.', 1),
      l('I sketch from your placements.', 1),
      l('Bear with me. 🎨', 1),
      drawing(4),
